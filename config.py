...
# data settings
# dataset_path = "/teamspace/studios/this_studio/BTAD_Dataset"  
# class_names = ["class_01","class_02", "class_03"]  # List of class names
# modelname_template = "model_{}"  # Template for model names




dataset_path = "/teamspace/studios/this_studio/differnet-master/Mvtec_dataset"  
class_names = [  "bottle", "capsule", "grid", "leather", "pill", "tile", 
                "transistor", "zipper", "cable", "carpet", "hazelnut", 
                "metal_nut", "screw", "toothbrush", "wood" ]  # List of class names
...
batch_size = 72 # actual batch size is this value multiplied by n_transforms(_test)
